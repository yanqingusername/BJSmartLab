...
export default{
    ...
    getinstrumentist(){//获取仪器列表
        axios({
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/getinstrument_type.hn",
            params: {
              is_delete:"0"
            }
          })
        ...
        axios({
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/getinstrument_info.hn",
            params: {
                page:page,
                limit:this.limit,
      ...
      if(this.editform.id==""){
        ...
        this.openVn("请填写仪器标签号");
           ...
           axios({
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/saveinstrumentedit.hn",
            params: {
             id :this.editform.id,
      ...
      if(this.editforminstrumentType.id==""){
        ...
        this.openVn("请选择仪器使用状态");
           ...
           axios({
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/saveinstrumentType.hn",
            params: {
    ...
    if(this.addforminstrumentType.instrument_type==""){
      ...
      axios({
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/addinstrumentType.hn",
            params: {
      ...
      if(this.addform.labinfo==""){
        ...
        this.openVn("请选择仪器使用状态");
           ...
           axios({
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/addinstrumentinfo.hn",
            params: {
