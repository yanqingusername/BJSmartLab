...
export default{
    ...
    getlablist(){//获取实验室列表
        ...
        axios({
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/getDSforecastlist.hn",
            params: {
     ...
     var phoneReg = /^(((13[0-9]{1})|(15[0-9]{1})|(14[0-9]{1})|(13[0-9]{1})|(19[0-9]{1})|(18[0-9]{1})|(17[0-9]{1})|(16[0-9]{1}))+\d{8})$/;
      ...
      console.log(this.Shiftform);
          if(this.Shiftform.addlablist==""){
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/createpredictDSdata.hn",
            params: {
