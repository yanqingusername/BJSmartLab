...
<template>
    <div class="app-container">
      <el-button  type="primary"  @click="getBatchNumber()" >查看基础数据设置说明</el-button>
    <br><br>
    <el-form
    :inline="true"
    ...
    <el-date-picker  v-model="searchObj.forecastdate" placeholder="选择排班日期" value-format="yyyy-MM-dd">  </el-date-picker>
    </el-form-item>

    <el-form-item label="班次">
        <el-select v-model="searchObj.Shift" placeholder="请选择班次">
          <el-option value="08:00:00-20:00:00" label="A班(08:00:00-20:00:00)"></el-option>
		  <el-option value="20:00:00-08:00:00" label="B班(20:00:00-次日08:00:00)"></el-option>
        </el-select>
      ...
      <el-form-item>
        ...
        <el-button type="primary" @click="addShift()">新增班次</el-button>
      </el-form-item>
    </el-form>
    <!-- 表格展示-->
    <el-table :data="list">
      <el-table-column label="实验室名称" prop="company" ></el-table-column>
      <el-table-column label="班次" prop="batch" ></el-table-column>
      <el-table-column label="排班时间" prop="record_date" ></el-table-column>
      <el-table-column label="预测检测数量/管" prop="estimated_detection_volume" ></el-table-column>
      <el-table-column label="负责人姓名" prop="charge_person_name" ></el-table-column>
      <el-table-column label="负责人手机号" prop="charge_person_phone" ></el-table-column>
      <el-table-column label="联络人姓名" prop="contact_person_name" ></el-table-column>
      <el-table-column label="联络人手机号" prop="contact_person_phone" ></el-table-column>
...
<el-dialog :close-on-click-modal="false"
    ...
    <el-form :model="Shiftform" label-position="right" label-width="120px" >
      ...
      <el-form-item label="排班日期 ">
        <el-date-picker v-model="Shiftform.batchdate" placeholder="请选择排班日期" style="width:240px" value-format="yyyy-MM-dd" ></el-date-picker>
      </el-form-item>
       <el-form-item label="班次">
  ...
  getBatchNumber() {
    ...
    getlablist(){//获取实验室列表
        axios({
            ...
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/getlabinfo.hn",
            params: {
        ...
        axios({
            method: `post`,
            //url:"http://192.168.81.15:8080/lislab/basic_data/getforecastlist.hn",
            //url:"https://scldev.coyotebio-lab.com:8443/lislab/basic_data/getforecastlist.hn",
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/getforecastlist.hn",
            params: {
             labname :this.searchObj.lablist,
             record_date :this.searchObj.forecastdate,
             batch :this.searchObj.Shift,
             page:page,
             limit:this.limit,
            }
          })
     ...
     var phoneReg = /^(((13[0-9]{1})|(15[0-9]{1})|(14[0-9]{1})|(13[0-9]{1})|(19[0-9]{1})|(18[0-9]{1})|(17[0-9]{1})|(16[0-9]{1}))+\d{8})$/;
      ...
      console.log(this.Shiftform);
          if(this.Shiftform.addlablist==""){
              ...
              this.openVn("请选择排班日期");
          }else if(this.Shiftform.batch==""){
              this.openVn("请选择班次");
          }else if(this.Shiftform.forecast==""){
              this.openVn("请填写预测量");
          }else if(this.Shiftform.charge_person_name==""){
              this.openVn("请填写负责人姓名");
          }else if(this.Shiftform.charge_person_phone==""){
              this.openVn("请填写负责人手机号");
          }else if(this.Shiftform.contact_person_name==""){
              this.openVn("请填写联系人姓名");
          }else if(this.Shiftform.contact_person_phone==""){
              this.openVn("请填写联系人手机号");
          }else{
              axios({
            method: `post`,
            //url:"http://192.168.81.15:8080/lislab/basic_data/createpredictdata.hn",
            //url:"https://scldev.coyotebio-lab.com:8443/lislab/basic_data/createpredictdata.hn",
            url:"https://lisalarm.coyotebio-lab.com/lislab/basic_data/createpredictdata.hn",
            params: {
             labname :this.Shiftform.addlablist,
             record_date :this.Shiftform.batchdate,
             batch :this.Shiftform.batch.split("&")[1],
             estimated_detection_volume:this.Shiftform.forecast,
             charge_person_name:this.Shiftform.charge_person_name,
             charge_person_phone:this.Shiftform.charge_person_phone,
             contact_person_name:this.Shiftform.contact_person_name,
             contact_person_phone:this.Shiftform.contact_person_phone,
             status:this.status,
             record_time:this.Shiftform.batch.split("&")[0]
            }
          })
        .then((response) => {
          console.log(response);
