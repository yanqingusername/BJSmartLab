...
<el-table
    ...
    >
      ...
      <template slot-scope="scope">
        <div :style="scope.row.batch_color1">{{scope.row.A1}}</div>
      </template>
      </el-table-column>
      ...
      label="2">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color2">{{scope.row.A2}}</div>
      </template>
      </el-table-column>
      ...
      label="3">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color3">{{scope.row.A3}}</div>
      </template>
      </el-table-column>
      ...
      label="4">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color4">{{scope.row.A4}}</div>
      </template>
      </el-table-column>
      ...
      label="5">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color5">{{scope.row.A5}}</div>
      </template>
      </el-table-column>
      ...
      label="6">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color6">{{scope.row.A6}}</div>
      </template>
      </el-table-column> 
      ...
      label="7">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color7">{{scope.row.A7}}</div>
      </template>
      </el-table-column> 
      ...
      label="8">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color8">{{scope.row.A8}}</div>
      </template>
      </el-table-column> 
      ...
      label="9">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color9">{{scope.row.A9}}</div>
      </template>
      </el-table-column> 
      ...
      label="10">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color10">{{scope.row.A10}}</div>
      </template>
      </el-table-column> 
      ...
      label="11">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color11">{{scope.row.A11}}</div>
      </template>
      </el-table-column> 
      ...
      label="12">
      <template slot-scope="scope">
        <div :style="scope.row.batch_color12">{{scope.row.A12}}</div>
      </template>
      </el-table-column> 
