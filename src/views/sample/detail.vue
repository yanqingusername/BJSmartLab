...
<el-table
    ...
    >
      ...
      <el-table-column prop="A1" label="1">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA1" style="color: red;">{{scope.row.A1}}</div>
          <div v-if="'阴性' == scope.row.test_resultA1" style="color: green;">{{scope.row.A1}}</div>
          <div v-if="'复检' == scope.row.test_resultA1" style="color: yellow;">{{scope.row.A1}}</div>
          <div v-if="'异常' == scope.row.test_resultA1" style="color: blue;">{{scope.row.A1}}</div>
          <div v-if="'' == scope.row.test_resultA1" style="color: black;">{{scope.row.A1}}</div>
      </template>
      </el-table-column> 

      <el-table-column prop="A2" label="2">
          <template slot-scope="scope">
            <div v-if="'阳性' == scope.row.test_resultA2" style="color: red;">{{scope.row.A2}}</div>
            <div v-if="'阴性' == scope.row.test_resultA2" style="color: green;">{{scope.row.A2}}</div>
            <div v-if="'复检' == scope.row.test_resultA2" style="color: yellow;">{{scope.row.A2}}</div>
            <div v-if="'异常' == scope.row.test_resultA2" style="color: blue;">{{scope.row.A2}}</div>
            <div v-if="'' == scope.row.test_resultA2" style="color: black;">{{scope.row.A2}}</div>
        </template>
      </el-table-column> 

      <el-table-column prop="A3" label="3">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA3" style="color: red;">{{scope.row.A3}}</div>
          <div v-if="'阴性' == scope.row.test_resultA3" style="color: green;">{{scope.row.A3}}</div>
          <div v-if="'复检' == scope.row.test_resultA3" style="color: yellow;">{{scope.row.A3}}</div>
          <div v-if="'异常' == scope.row.test_resultA3" style="color: blue;">{{scope.row.A3}}</div>
          <div v-if="'' == scope.row.test_resultA3" style="color: black;">{{scope.row.A3}}</div>
      </template>
      </el-table-column>

      <el-table-column prop="A4" label="4">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA4" style="color: red;">{{scope.row.A4}}</div>
          <div v-if="'阴性' == scope.row.test_resultA4" style="color: green;">{{scope.row.A4}}</div>
          <div v-if="'复检' == scope.row.test_resultA4" style="color: yellow;">{{scope.row.A4}}</div>
          <div v-if="'异常' == scope.row.test_resultA4" style="color: blue;">{{scope.row.A4}}</div>
          <div v-if="'' == scope.row.test_resultA4" style="color: black;">{{scope.row.A4}}</div>
      </template>
      </el-table-column> 

      <el-table-column prop="A5" label="5">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA5" style="color: red;">{{scope.row.A5}}</div>
          <div v-if="'阴性' == scope.row.test_resultA5" style="color: green;">{{scope.row.A5}}</div>
          <div v-if="'复检' == scope.row.test_resultA5" style="color: yellow;">{{scope.row.A5}}</div>
          <div v-if="'异常' == scope.row.test_resultA5" style="color: blue;">{{scope.row.A5}}</div>
          <div v-if="'' == scope.row.test_resultA5" style="color: black;">{{scope.row.A5}}</div>
      </template>
      </el-table-column> 

      <el-table-column prop="A6" label="6">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA6" style="color: red;">{{scope.row.A6}}</div>
          <div v-if="'阴性' == scope.row.test_resultA6" style="color: green;">{{scope.row.A6}}</div>
          <div v-if="'复检' == scope.row.test_resultA6" style="color: yellow;">{{scope.row.A6}}</div>
          <div v-if="'异常' == scope.row.test_resultA6" style="color: blue;">{{scope.row.A6}}</div>
          <div v-if="'' == scope.row.test_resultA6" style="color: black;">{{scope.row.A6}}</div>
      </template>
      </el-table-column>  

      <el-table-column prop="A7" label="7">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA7" style="color: red;">{{scope.row.A7}}</div>
          <div v-if="'阴性' == scope.row.test_resultA7" style="color: green;">{{scope.row.A7}}</div>
          <div v-if="'复检' == scope.row.test_resultA7" style="color: yellow;">{{scope.row.A7}}</div>
          <div v-if="'异常' == scope.row.test_resultA7" style="color: blue;">{{scope.row.A7}}</div>
          <div v-if="'' == scope.row.test_resultA7" style="color: black;">{{scope.row.A7}}</div>
      </template>
      </el-table-column>  

      <el-table-column prop="A8" label="8">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA8" style="color: red;">{{scope.row.A8}}</div>
          <div v-if="'阴性' == scope.row.test_resultA8" style="color: green;">{{scope.row.A8}}</div>
          <div v-if="'复检' == scope.row.test_resultA8" style="color: yellow;">{{scope.row.A8}}</div>
          <div v-if="'异常' == scope.row.test_resultA8" style="color: blue;">{{scope.row.A8}}</div>
          <div v-if="'' == scope.row.test_resultA8" style="color: black;">{{scope.row.A8}}</div>
      </template>
      </el-table-column> 

      <el-table-column prop="A9" label="9">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA9" style="color: red;">{{scope.row.A9}}</div>
          <div v-if="'阴性' == scope.row.test_resultA9" style="color: green;">{{scope.row.A9}}</div>
          <div v-if="'复检' == scope.row.test_resultA9" style="color: yellow;">{{scope.row.A9}}</div>
          <div v-if="'异常' == scope.row.test_resultA9" style="color: blue;">{{scope.row.A9}}</div>
          <div v-if="'' == scope.row.test_resultA9" style="color: black;">{{scope.row.A9}}</div>
      </template>
      </el-table-column>

      <el-table-column prop="A10" label="10">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA10" style="color: red;">{{scope.row.A10}}</div>
          <div v-if="'阴性' == scope.row.test_resultA10" style="color: green;">{{scope.row.A10}}</div>
          <div v-if="'复检' == scope.row.test_resultA10" style="color: yellow;">{{scope.row.A10}}</div>
          <div v-if="'异常' == scope.row.test_resultA10" style="color: blue;">{{scope.row.A10}}</div>
          <div v-if="'' == scope.row.test_resultA10" style="color: black;">{{scope.row.A10}}</div>
      </template>
      </el-table-column> 

      <el-table-column prop="A11" label="11">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA11" style="color: red;">{{scope.row.A11}}</div>
          <div v-if="'阴性' == scope.row.test_resultA11" style="color: green;">{{scope.row.A11}}</div>
          <div v-if="'复检' == scope.row.test_resultA11" style="color: yellow;">{{scope.row.A11}}</div>
          <div v-if="'异常' == scope.row.test_resultA11" style="color: blue;">{{scope.row.A11}}</div>
          <div v-if="'' == scope.row.test_resultA11" style="color: black;">{{scope.row.A11}}</div>
      </template>
      </el-table-column> 

      <el-table-column prop="A12" label="12">
        <template slot-scope="scope">
          <div v-if="'阳性' == scope.row.test_resultA12" style="color: red;">{{scope.row.A12}}</div>
          <div v-if="'阴性' == scope.row.test_resultA12" style="color: green;">{{scope.row.A12}}</div>
          <div v-if="'复检' == scope.row.test_resultA12" style="color: yellow;">{{scope.row.A12}}</div>
          <div v-if="'异常' == scope.row.test_resultA12" style="color: blue;">{{scope.row.A12}}</div>
          <div v-if="'' == scope.row.test_resultA12" style="color: black;">{{scope.row.A12}}</div>
      </template>
      </el-table-column> 
