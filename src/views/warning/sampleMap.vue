    ...
    <el-form-item style="margin-left: 5%;" label="来源" prop="carNum">
      ...
      <el-form-item label="采样点" prop="channelName">
        <el-select
          ...
          placeholder="全部"
          @change="getSampleChannelBarDetailInfo()"
        >
      ...
      <!-- <el-button type="info" style="width: 210px;height: 50px;background-color: #DCDFE6;border-color: #DCDFE6;color: #303133;">预测采样总量 30000</el-button> -->
...
<el-pagination
            ...
            @current-change="getSampleChannelBarDetailInfo"
          />
      </el-div>
...
export default {
  ...
  created() {
    ...
    this.getSampleChannelBarDetailInfo();
  ...
  methods: {
    ...
    getEastSampleNumInfo() { 
     ...
     //获取采样趋势图曲线
    getSampleChannelBarDetailInfo(val) { 
      //alert(val)
      ...
      axios({
        method: "get",
        //url: "http://localhost:8070/lislab_war_exploded/warning/getSampleChannelBarDetailInfo.hn",
        url: this.url1+"/warning/getSampleChannelBarDetailInfo.hn",
        params: {
          channel_id: this.searchObj.channel_id2,
          sample_source: this.searchObj.sample_source3,
          company_serial:this.searchObj.company_serial2,
